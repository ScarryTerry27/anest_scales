def check_elganzouri(elganzouri_flag: dict):
    ...
    result_dict = {
        8: ("Интубация трахеи в сознании при бронхоскопии", "Крайне-высокий"),
        4: ("Интубация трахеи при видеоларингоскопии", "Высокий"),
    }
    result = ("Интубация трахеи при обычной ларингоскопии", "Низкий")
